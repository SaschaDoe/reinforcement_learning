...
class ScoreLogger:
    ...
    def __init__(self, env_name, name):
        self.scores = deque(maxlen=CONSECUTIVE_RUNS_TO_SOLVE)
        self.env_name = env_name
        self.name = name
        SCORES_CSV_PATH = "./scores/scores"+name+".csv"
        SCORES_PNG_PATH = "./scores/scores"+name+".png"
        SOLVED_CSV_PATH = "./scores/solved"+name+".csv"
        SOLVED_PNG_PATH = "./scores/solved"+name+".png"
